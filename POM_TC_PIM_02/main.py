...
class Gokul:
    ...
    def login(self):
        ...
        self.driver.find_element(by=By.XPATH, value=Gokul_Locators().Employee_ID_edit).click()
        self.driver.find_element(by=By.XPATH, value=Gokul_Locators().Employee_ID_edit_save).click()
